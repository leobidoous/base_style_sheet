...
class _PagedTableViewState<E, S> extends State<PagedTableView<E, S>> {
  ...
  WidgetStateProperty<Color> get _headingRowColor => WidgetStatePropertyAll(
  ...
  Widget _tableBody(List<S> state) {
  ...
  Widget _tableView(List<S> state) {
    return Column(
      crossAxisAlignment: .stretch,
      children: [
