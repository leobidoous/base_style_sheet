...
class AppThemeBase {
  ...
  static BoxShadow get shadowLightmodeLevel4 =>
      const BoxShadow(blurRadius: 18, offset: Offset(0, 16));
  static BoxShadow get shadowLightmodeLevel5 =>
      const BoxShadow(blurRadius: 8, offset: Offset(2, 0));
  static BoxShadow get shadowLightmodeLevel6 =>
      const BoxShadow(color: Color.fromRGBO(172, 186, 202, 0.035));
